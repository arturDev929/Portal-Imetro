...
function GestaoFuncionariosAdm() {
  ...
  const [totalFuncionariosDesativados, setTotalFuncionariosDesativados] =
    useState(0);
              ...
              <div className="d-flex justify-content-between align-items-center">
                <div>
                  ...
                  <p className="text-muted mb-0">
                    Bem-vindo, {user ? user.nome : "Administrador"} | Gestão do
                ...
                <div className="col-md-3">
                  <div
                    ...
                    style={{
                      borderRadius: "15px",
                      background:
                        "linear-gradient(135deg, #DC143C 0%, #FF4500 100%)",
                    }}
                  >
                    <div className="card-body">
                      <div className="d-flex justify-content-between align-items-start mb-3">
                  ...
                  >
                    <div className="card-header bg-white border-0 pt-4 px-4">
                      ...
                      <p className="text-muted small mb-0">
                        Percentual de ativos vs desativados
                      </p>
                    </div>
                    <div className="card-body">
                            ...
                            >
                              {dadosGrafico.map((entry, index) => (
                                <Cell
                                  key={`cell-${index}`}
                                  fill={
                                    entry.cor || COLORS[index % COLORS.length]
                                  }
                                />
                              ))}
                            </Pie>
                ...
                <div className="col-12">
                  ...
                  >
                    <div className="card-header bg-white border-0 pt-4 px-4">
                      ...
                      <p className="text-muted small mb-0">
                        Lista de funcionários com estado 'Desativado'
                      </p>
                    </div>
                    <div className="card-body">
                      {erroDesativados ? (
